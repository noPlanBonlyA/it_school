  ...
  return (
    <>
      <nav className="sidebar">
        ...
        <ul className="sidebar-list">{main.map(item)}</ul>
        ...
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <div className="modal-buttons">
              <button className="btn-primary"   onClick={() => navigate(routes.logout)}>Да</button>
              <button className="btn-secondary" onClick={() => setShowLogout(false)}>Нет</button>
            </div>
          </div>
        </div>
      )}
